...
Objective:
This code aims to predict future glucose levels using only past glucose data from diabetic patients. The prediction model is based on an LSTM (Long Short-Term Memory) 
